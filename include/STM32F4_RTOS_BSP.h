...
#define CH0					GPIO_PIN_1   //Probe Channel 0 PIN
#define CH1					GPIO_PIN_2   //Probe Channel 1 PIN
#define CH2					GPIO_PIN_4   //Probe Channel 2 PIN
#define CH3					GPIO_PIN_5   //Probe Channel 3 PIN
